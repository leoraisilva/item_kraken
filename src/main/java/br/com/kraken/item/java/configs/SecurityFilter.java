package br.com.kraken.item.java.configs;

import br.com.kraken.item.java.repository.AcessoRepository;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    public SecurityFilter(AcessoRepository repository, TokenService tokenService) {
